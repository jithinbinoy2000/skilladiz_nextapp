    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {item.title && (
            <p className="mt-3 text-center text-sm text-white/60">{item.title}</p>
          )}
        </motion.div>
      </motion.div>
    </AnimatePresence>
    ...
    >
      ...
      <div className="relative aspect-video bg-white/5">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          {item.type === "video" ? (
            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/40 bg-white/10 backdrop-blur">
    ...
    <div className="text-white bg-black main-wrapper">
      ...
      <main>
        ...
        <section className="sticky top-16 z-20 border-b border-white/10 bg-black/90 backdrop-blur-md">
          <div className="w-full max-w-6xl px-6 mx-auto py-3">
