    ...
    <div ref={rootRef} className="text-white bg-black main-wrapper">
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-black">
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-24 lg:py-32 lg:grid-cols-[1.1fr_0.9fr]">
            <motion.div
              className="space-y-8"
            ...
            >
              ...
              <motion.h1
                className="font-display text-3xl uppercase tracking-[.15em] leading-20 text-white sm:text-6xl lg:text-7xl"
                variants={fadeUpVariant}
              >
            ...
            >
              <Magnet padding={200} disabled={false} magnetStrength={5}>
                  <div className="relative h-[360px] w-[360px] sm:h-[460px] sm:w-[460px] rounded-full border border-white/20">
...
.map((item, idx) => (
 ...
 border-l ps-6 first:ps-0 first:border-l-0 border-white/10">
          ...
          <p className="text-base  tracking-[.05em] text-white/70">{item.desc}</p>
          <a
            href="/contact"
...
<div className="absolute inset-0 z-10 pointer-events-none bg-black/20 backdrop-blur-sm" />
  ...
  {/* Content */}
  <div className="relative z-20 w-full px-6 py-20 mx-auto pointer-events-none max-w-7xl">
    ...
    >
      {plans.map((plan, idx) => (
        ...
        >
          ...
          {/* Features */}
          <ul className="grid gap-3 mb-2 text-xs text-white/70">
