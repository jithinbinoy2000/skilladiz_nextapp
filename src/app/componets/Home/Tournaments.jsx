...
//       <GridPattern/>
//       {/* Hero Section */}
//       <section className=" text-white  pt-20 max-w-[1500px] mx-auto  py-20 px-4 relative ">
...
//       {/* Tournament Tabs */}
//       <section className=" max-w-[1500px] mx-auto  py-20 px-4 relative">
...
//                 <GlowCard key={tournament.id} className="p-6">
//                   <img 
...
const Tournaments = () => {
  ...
  return (
    <div className="min-h-screen bg-black py-20 px-4 relative overflow-hidden">
      <GridPattern className="text-white/20 absolute inset-0 pointer-events-none" />

      {/* Hero Section */}
      <section className="max-w-[1500px] mx-auto py-20 px-4 relative text-center md:text-left text-white">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent">
          Tournaments
        </h1>
        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
      ...
      <section className="max-w-[1500px] mx-auto py-16 px-4">
        <div className="flex justify-center mb-12">
          <div className="bg-gray-900 rounded-lg p-2 flex space-x-4">
            <button
        ...
        {activeTab === 'upcoming' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {upcomingTournaments.map((tournament) => (
              <GlowCard 
                key={tournament.id} 
                className="p-6 bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300"
              >
                <img 
                  src={tournament.image} 
                  alt={tournament.name}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {pastTournaments.map((tournament) => (
              <GlowCard 
                key={tournament.id} 
                glowColor="green" 
                className="p-6 bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col sm:flex-row gap-6"
              >
                <img 
                  src={tournament.image} 
                  alt={tournament.name}
