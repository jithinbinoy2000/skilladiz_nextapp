...
export const GlareCard = ({ children, className }) => {
  ...
  return (
    ...
    >
      <div className="w-full  h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)]  hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden">
